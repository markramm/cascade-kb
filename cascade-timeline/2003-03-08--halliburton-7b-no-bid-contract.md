...
title: Halliburton KBR Receives $7 Billion No-Bid Iraq Contract Through Systematic
  Corporate-State Fusion Infrastructure Coordination
actors:
- Dick Cheney
...
- crisis-accelerated-corporate-integration
- constitutional-accountability-bypass
- systematic-conflict-of-interest
- corporate-policy-implementation
- whig-template-expansion
sources:
- title: Email indicates Cheney involved in Halliburton deal in Iraq
...
status: confirmed
triggered_by:
- 2002-09-15--powell-memo-institutional-network-whig-crisis-coordination
- 2003-05-01--powell-whig-template-establishes-crisis-accelerated-capture-blueprint
constitutional_violations:
- Systematic bypass of competitive bidding requirements through corporate-government
  coordination
- Due process violations through private corporate control of public military infrastructure
  functions
- Constitutional accountability circumvention through contractor relationship establishment
- Equal protection erosion through preferential treatment of connected corporations
  over competitive process
historical_significance: The Halliburton no-bid contract marks the systematic expansion
  of WHIG corporate coordination template from media manipulation to comprehensive
  corporate-state fusion, demonstrating how crisis conditions enable systematic transfer
  of public functions to private corporate control through established revolving door
