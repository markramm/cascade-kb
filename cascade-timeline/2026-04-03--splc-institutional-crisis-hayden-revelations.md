...
tags:
- splc
- far-right-monitoring
- watchdog-degradation
- fbi
- institutional-capture
sources:
- title: "What Happened to the SPLC—and Me"
  url: https://michaeledisonhayden.substack.com/p/what-happened-to-the-splcand-me
  outlet: Extreme Measures (Substack)
  date: '2026-04-03'
  tier: 2
- title: "What Went Wrong with the Southern Poverty Law Center?"
  url: https://www.heritage.org/progressivism/heritage-explains/what-went-wrong-the-southern-poverty-law-center
  outlet: Heritage Foundation
  date: '2026-04-03'
  tier: 3
- title: Southern Poverty Law Center's hate map survives legal challenge
  url: https://www.washingtontimes.com/news/2026/jan/11/southern-poverty-law-centers-hate-map-survives-legal-challenge/
...
- [[2025-12-04--bondi-fbi-domestic-terrorism-memo|Bondi's December 2025 FBI domestic terrorism memo]] and [[2025-09-25--nspm-7-domestic-terrorism-targets-anti-capitalist-beliefs|NSPM-7]] targeted groups that SPLC had designated as hate organizations, effectively reversing the relationship: organizations the SPLC monitored became the administration's allies, while organizations the SPLC defended became targets
- FBI Director [[patel-kash|Kash Patel]] formally severed the FBI's ties with the SPLC, stating: "The Southern Poverty Law Center long ago abandoned civil rights work and turned into a partisan smear machine"
- The Heritage Foundation published analyses framing the SPLC's decline as vindication of conservative complaints about ideological bias in civil rights monitoring

## Significance

The SPLC's degradation mattered because it was one of only a handful of organizations with the institutional capacity to track organized white nationalism at scale. The Hatewatch program had produced the investigative reporting that exposed [[2019-11-12--splc-exposes-miller-white-nationalist-emails|Stephen Miller's 900 white nationalist emails]], documented the [[2016-05-17--cnp-2014-membership-directory-leaked-splc|Council for National Policy's secret membership]], and maintained the most comprehensive public database of hate groups in the United States.
...
- Exact number of Intelligence Project staff terminated in the 2024 purge
- Whether Hatewatch is still publishing investigations at prior frequency
- Current SPLC budget and staffing compared to 2023 levels
- Whether any successor organizations have filled the monitoring gap
