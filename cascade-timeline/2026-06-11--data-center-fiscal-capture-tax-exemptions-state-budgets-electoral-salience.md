...
named_actors:
  ...
  - Gov. Josh Shapiro (Pennsylvania, administration cost estimate)
  - State legislatures (TX, PA, GA, VA, OH, UT, and others)
location: Multi-state (United States; TX / PA / GA / VA emphasized)
tags:
  - data-colonialism
  - data-centers
  - sales-tax-exemption
  ...
  - ai-infrastructure
  - electoral-salience
provenance: feed-archive backfill — synthesized from a same-window cluster discovered in the social-archive independent-RSS sweep, missed by the prior WebSearch-only daily-capture pass — the-lever ("Data Centers Are Messing With Texas," 2026-06-11), beat-capital-main ("Data Centers Are on the Ballot — This Pennsylvania Candidate Won Her Primary Keeping Them Top of Mind," 2026-06-10), and indie-popular-information ("How data centers are blowing a hole in state budgets," 2026-06-10). Corroborated tier-1-equivalent against Spotlight PA, Stateline, MultiState, and Good Jobs First.
sources:
  - title: "Data Centers Are Messing With Texas"
    url: https://www.levernews.com/data-centers-are-messing-with-texas/
    publisher: The Lever
    date: '2026-06-11'
    tier: 1-equivalent
  - title: "Data Centers Are on the Ballot — This Pennsylvania Candidate Won Her Primary Keeping Them Top of Mind"
    url: https://capitalandmain.com/data-centers-are-on-the-ballot-this-pennsylvania-candidate-won-her-primary-keeping-them-top-of-mind
    publisher: Capital & Main
    date: '2026-06-10'
    tier: 1-equivalent
  - title: "How data centers are blowing a hole in state budgets"
    url: https://popular.info/p/how-data-centers-are-blowing-a-hole
    publisher: Popular Information (Judd Legum)
    date: '2026-06-10'
    tier: 1-equivalent
  - title: "PA data center tax break expected to cost $2B"
    url: https://www.spotlightpa.org/news/2026/02/data-centers-pennsylvania-tax-break-sales-exemption-capitol/
    publisher: Spotlight PA
    date: '2026-02'
    tier: 1-equivalent
  - title: "Data center tax breaks are on the chopping block in some states"
    url: https://stateline.org/2026/02/24/data-center-tax-breaks-are-on-the-chopping-block-in-some-states/
    publisher: Stateline
    date: '2026-02-24'
    tier: 1-equivalent
related_events:
...
- A per-state ledger of enacted vs. proposed sales-tax-exemption repeals (which states actually repealed vs. merely filed bills) would convert this synthesis into a sourced procurement/fiscal table — strong candidate for a `procurement-deep-dive` or `regulatory-rulemaking` ticket.
- The specific Pennsylvania primary candidate's name and district (Capital & Main) should be pinned to a primary source before any RAMM/Notes use.
