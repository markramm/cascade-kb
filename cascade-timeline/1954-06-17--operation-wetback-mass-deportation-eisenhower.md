...
- deaths-in-custody
- due-process-waiver
- military-to-civilian-enforcement-pipeline
- immigration-detention-ancestor
- criminalize-then-monetize
sources:
- title: The Largest Mass Deportation in American History
  url: https://www.history.com/articles/operation-wetback-eisenhower-1954-deportation
  outlet: History.com
  tier: 2
  verified: true
- title: Operation Wetback
  ...
  tier: 2
  verified: true
- title: Operation Wetback (1953-1954)
  url: https://immigrationhistory.org/item/operation-wetback/
...
- Military-to-Enforcement Pipeline
---
...
**Structural ancestor note (military-to-enforcement pipeline + deaths-in-custody):** Operation Wetback is the first major deployment of a former military general (Swing) to command immigration enforcement and the first mass deportation operation to produce documented in-custody deaths from removal conditions. The "ship-as-prison" model — bodies crowded into cattle-car transport — prefigures the 2025-26 pattern of military planes (removed detainees on C-17s) and the GTMO detention holding. Swing's military-style command structure is the ancestor of the 2025 ICE director model under Tom Homan, who similarly frames deportation as military campaign. The racial-profiling stop-without-documentation pattern is the direct ancestor of 287(g) and Secure Communities programs. See: [[1997-10-01--287g-program-created-local-police-immigration-enforcement]], [[1996-09-30--iirira-clinton-expands-deportation-enforcement]], [[ice-bp-recruitment-replenishment-pipeline]].
