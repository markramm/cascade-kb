---
type: timeline_event
id: 2025-10-25--ice-deports-souvannarath-despite-court-order-laos
date: 2025-10-25
title: ICE Deports Man to Laos Despite Federal Court Order Blocking Removal, Ignoring Torture and Persecution Risk
description: ICE deported Chanthila "Shawn" Souvannarath to Laos on October 25, 2025, in direct violation of a temporary restraining order issued by Chief Judge Shelly Dick of the U.S. District Court for the Middle District of Louisiana the day before. Judge Dick had ordered ICE to keep Souvannarath in the United States for 14 days while the court reviewed his "substantial claim of U.S. citizenship." The deportation occurred despite documented risks of torture and persecution in Laos, where the authoritarian one-party state systematically restricts fundamental civil and political rights, and where ethnic minorities face arbitrary detention, enforced disappearances, and credible reports of torture by government officials. This marked the latest in a pattern of ICE defying federal court orders during the Trump administration's mass deportation campaign.
status: confirmed
importance: 9
location: Louisiana / Laos
actors:
- Chanthila "Shawn" Souvannarath
...
sources:
- title: ICE Deports Man Claiming U.S. Citizenship to Laos Despite Federal Court Order
  url: https://nipnlg.org/news/press-releases/ice-deports-man-claiming-us-citizenship-laos-despite-federal-court-order
  outlet: National Immigration Project of the National Lawyers Guild
  date: '2025-10-29'
  tier: 2
- title: Chanthila "Shawn" Souvannarath Deported to Laos Despite Court Order Blocking His Removal
  url: https://www.democracynow.org/2025/10/29/headlines/chanthila_shawn_souvannarath_deported_to_laos_despite_court_order_blocking_his_removal
  outlet: Democracy Now!
  date: '2025-10-29'
  tier: 2
- title: Judge's order blocking removal of man from U.S. wasn't received until after he was deported, DHS says
  url: https://www.nbcnews.com/news/us-news/judges-order-blocking-removal-man-us-wasnt-received-was-deported-dhs-s-rcna240739
  outlet: NBC News
  date: '2025-10-28'
  tier: 1
- title: Laotian American man deported to Laos despite court order blocking his removal, attorneys say
  url: https://gasiantimes.com/nation/2025/10/29/laotian-american-man-deported-to-laos-despite-court-order-blocking-his-removal-attorneys-say/
  outlet: Georgia Asian Times
  date: '2025-10-29'
  tier: 3
- title: 2023 Country Reports on Human Rights Practices - Laos
  url: https://2021-2025.state.gov/reports/2023-country-reports-on-human-rights-practices/laos/
...
- Trump administration pattern of defying 35% of court orders (2025-07-21)
- Judge finds probable cause for criminal contempt over El Salvador deportations (2025-04-16)
patterns:
- court-defiance
- judicial-capture
- human-rights-violations
