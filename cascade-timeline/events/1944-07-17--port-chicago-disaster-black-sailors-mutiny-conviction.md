...
sources:
- title: Port Chicago Naval Magazine Explosion
  url: https://www.nps.gov/poch/learn/historyculture/index.htm
  outlet: National Park Service
  date: '2024-01-01'
  verified: true
  tier: 1
- title: The Port Chicago Mutiny
  url: https://www.history.navy.mil/content/history/nhhc/research/library/online-reading-room/title-list-alphabetically/p/port-chicago-naval-magazine-explosion.html
  outlet: Naval History and Heritage Command
  date: '2024-01-01'
  verified: true
  tier: 1
- title: Port Chicago Sailors Convicted in Mass Trial
  url: https://www.britannica.com/event/Port-Chicago-mutiny
  outlet: Britannica
  date: '2024-01-01'
  verified: true
  tier: 2
