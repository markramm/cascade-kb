...
capture_lanes:
- Surveillance State
- Corporate-Government Merger
- Enforcement Impunity
date: '2026-02-19'
id: 2026-02-19--ice-covert-suburban-tactics-palantir-elite-surveillance
importance: 8
sources:
- date: '2026-02-19'
  outlet: Sahan Journal
  tier: 1
  title: Minnesota suburbs see 'stealthier' tactics as ICE stays active
  url: https://sahanjournal.com/immigration/ice-minnesota-suburbs-operation-metro-surge/
- date: '2026-02-20'
  outlet: Eden Prairie Local News
  tier: 2
  title: Operation Metro Surge hasn't ended. It's expanded to the suburbs.
  url: https://www.eplocalnews.org/2026/02/20/operation-metro-surge-hasnt-ended-its-expanded-to-the-suburbs/
- date: '2026-01-01'
  outlet: 404 Media
  tier: 1
...
- date: '2026-02-02'
  ...
  tier: 1
  title: How ICE is using surveillance technology in immigration crackdowns
  url: https://www.wbur.org/hereandnow/2026/02/02/ice-surveillance-technology
- date: '2026-02-01'
...
- date: '2026-01-01'
  ...
  tier: 2
  title: ICE using data and probability to decide where to detain and arrest people
  url: https://www.biometricupdate.com/202601/ice-using-data-and-probability-to-decide-where-to-detain-and-arrest-people
- date: '2026-01-01'
...
- date: '2026-02-01'
  outlet: Sahan Journal
  tier: 1
  title: ICE's surveillance technology goes beyond facial recognition
  url: https://sahanjournal.com/immigration/ice-surveillance-technology-facial-recognition-phones-minnesota/
status: confirmed
tags:
- surveillance-state
...
- **License plate readers**: ICE contracts with Motorola Solutions (through a Thomson Reuters subsidiary) for a $6 million database of automated license plate reader (ALPR) data covering a large percentage of American vehicles, enabling retrospective location tracking.
- **Phone location tracking**: The Webloc tool allows ICE to geolocate mobile phones without a warrant by drawing a virtual perimeter around a neighborhood and retrieving location data for all phones present.
- **Phone data extraction**: An $11 million contract with Cellebrite enables agents to unlock phones and extract complete device images, including Signal and WhatsApp messages, call records, photos, and notes.
- **Iris scanning**: ICE holds a contract with BI2 Technologies for iris-scanning capability via agent smartphones, with unlimited access to the largest iris biometric database built for law enforcement.
- **Facial recognition**: The Mobile Fortify system had been used in the field more than 100,000 times, according to a lawsuit filed by Illinois and Chicago against DHS.
