...
- title: 'Pegasus vs. Predator: Dissident Doubly-Infected iPhone Reveals Cytrox Mercenary Spyware'
  ...
  key_facts_confirmed:
  - 'Detailed technical analysis of Cytrox''s Predator spyware'
  - 'Confirmation of Cytrox''s establishment and methods'
  - Technical investigation of spyware targeting
  verified: true
- title: Predator Spyware Firm Intellexa Resurgent After U.S. Sanctions
  url: 'https://www.icij.org/investigations/cyprus-confidential/predator-spyware-firm-intellexa-resurgent-after-u-s-sanctions/'
  outlet: International Consortium of Investigative Journalists
  date: '2024-01-01'
  type: investigative_journalism
  key_facts_confirmed:
  - Connection between Cytrox and Intellexa
  - 'Details of spyware company''s operations'
  - Impact of U.S. government sanctions
  verified: true
  tier: 1
- title: 'US Sanctions Firms from Greece, North Macedonia Linked to Spyware Consortium'
  url: 'https://balkaninsight.com/2024/03/06/us-sanctions-greek-north-macedonian-firms-linked-to-spyware-consortium/'
  outlet: Balkan Insight
  date: '2024-03-06'
  type: news_reporting
  key_facts_confirmed:
  - U.S. government actions against Cytrox
  - 'Detailed timeline of spyware company''s establishment'
  - International surveillance industry connections
  verified: true
  tier: 2
- title: Two European Spyware Firms Added to US Export Blacklist
  url: 'https://apnews.com/article/spyware-cyber-surveillance-technology-privacy-greece-4ae8fe5f5f73a5c34bf4fdd4be2fe83f'
  outlet: Associated Press
  date: '2023-07-25'
  type: news_reporting
  key_facts_confirmed:
  - U.S. Commerce Department blacklisted Cytrox
  - Detailed government actions against spyware companies
  - International surveillance technology tracking
  verified: true
  tier: 1
importance: 8
status: confirmed
