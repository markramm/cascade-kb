...
- outlet: Tax Notes
  date: '2022-07-01'
  url: 'https://www.taxnotes.com/tax-notes-today-federal/criminal-investigations/roger-stone-settles-tax-case'
  title: Roger Stone settles $2.1 million tax fraud case
  tier: 2
- outlet: CNBC
  date: '2022-07-01'
  url: 'https://www.cnbc.com/2022/07/01/roger-stone-settles-justice-department-civil-suit'
  title: Roger Stone settles Justice Department civil suit over unpaid taxes
  tier: 2
- outlet: Florida Bulldog
  date: '2022-07-02'
  url: 'https://www.floridabulldog.org/2022/07/roger-stone-drake-ventures-tax-settlement'
  title: 'Stone''s Drake Ventures shell company central to tax fraud settlement'
  tier: 2
connections:
- 2019-11-15--roger-stone-convicted
- 2020-07-10--roger-stone-sentence-commuted
- 2020-12-23--roger-stone-pardoned
patterns:
- financial-crimes
- shell-companies
- tax-evasion
...
The Drake Ventures case emerged as Stone was simultaneously navigating the aftermath of his 2019 federal conviction for witness tampering, obstruction, and lying to Congress—a conviction that President Trump commuted in 2020 and fully pardoned in late 2020. The shell company arrangement demonstrated Stone's comfort with sophisticated financial structures to conceal assets and evade oversight, skills developed over decades as a political operative. The settlement illustrated how presidential pardons for criminal convictions do not eliminate civil tax liability, and that Stone's financial entanglements with federal authorities extended beyond his better-known political crimes.
