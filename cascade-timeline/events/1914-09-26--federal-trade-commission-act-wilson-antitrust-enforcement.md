---
type: timeline_event
id: 1914-09-26--federal-trade-commission-act-wilson-antitrust-enforcement
date: '1914-09-26'
title: 'Wilson Signs Federal Trade Commission Act, Creating Expert Antitrust Enforcement Agency'
importance: 9
actors:
- Woodrow Wilson
...
- corporate-power
sources:
- title: Federal Trade Commission Act of 1914 - Wikipedia
  url: 'https://en.wikipedia.org/wiki/Federal_Trade_Commission_Act_of_1914'
  tier: 2
  outlet: Wikipedia
- title: Our History
  url: 'https://www.ftc.gov/about-ftc/history'
  outlet: Federal Trade Commission
  tier: 1
- title: 'The Origins of the FTC: Concentration, Cooperation, Control, and Competition'
  url: 'https://www.ftc.gov/sites/default/files/attachments/federal-trade-commission-history/origins.pdf'
  outlet: Federal Trade Commission
  tier: 1
- title: Federal Trade Commission Act (FTCA)
  url: 'https://www.britannica.com/money/Federal-Trade-Commission-Act'
  outlet: Britannica
  tier: 2
status: confirmed
capture_lanes:
