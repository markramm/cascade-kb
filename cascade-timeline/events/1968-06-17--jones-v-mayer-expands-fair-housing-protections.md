...
- title: Jones v. Alfred H. Mayer Co.
  outlet: Wikipedia
  url: https://en.wikipedia.org/wiki/Jones_v._Alfred_H._Mayer_Co.
  tier: 3
  verified: true
- title: Jones v. Mayer Supreme Court Case Explained
  outlet: Real Estate License Wizard
  url: https://realestatelicensewizard.com/jones-v-mayer/
  tier: 2
  verified: true
status: confirmed
capture_lanes:
