---
type: timeline_event
id: 2021-11-22--sec-fines-mckinsey-mio-puerto-rico-conflict
date: '2021-11-22'
...
sources:
- title: SEC fines McKinsey for failures related to Puerto Rico debt
  url: https://www.bondbuyer.com/news/sec-fines-mckinsey-for-failues-related-to-puerto-rico-debt
  outlet: The Bond Buyer
  tier: 2
- title: MIO Partners, Inc. - SEC Administrative Proceeding
  url: https://www.sec.gov/files/litigation/admin/2021/ia-5912.pdf
  outlet: U.S. Securities and Exchange Commission
  tier: 1
- title: McKinsey Unit Pays $18 Million to SEC in Latest Compliance Lapse
  url: https://news.bloomberglaw.com/esg/mckinsey-unit-fined-18-million-over-sec-compliance-failures
  outlet: Bloomberg Law
  tier: 2
- title: Million-dollar fine to Board consultant for conflict of interest with PR's debt
  url: https://www.archyde.com/million-dollar-fine-to-board-consultant-for-conflict-of-interest-with-prs-debt-noticel-the-truth-as-it-is-puerto-rico-news-noticel/
  outlet: NotiCel/Archyde
  tier: 2
status: confirmed
capture_lanes:
