...
**GRU hacks DNC** → **Transfers to WikiLeaks via Guccifer 2.0** → **WikiLeaks times release for maximum impact** → **Trump campaign amplifies** → **Media covers stolen materials as news** → **Electoral damage achieved**
