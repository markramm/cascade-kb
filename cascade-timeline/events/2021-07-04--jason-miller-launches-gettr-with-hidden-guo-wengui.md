...
type: timeline_event
date: '2021-07-04'
title: Jason Miller Launches Gettr with Hidden Guo Wengui Funding
description: Gettr's launch revealed intricate financial connections between conservative
  media figures, a fugitive Chinese billionaire, and a social media platform marketed
  as a 'cancel-free' alternative for American conservatives. Multiple investigations
  uncovered the platform's deep financial ties to Guo Wengui's network, challenging
...
importance: 9
sources:
- title: Trumpworld App Is Bankrolled by Fugitive Chinese Billionaire
...
- trump-aligned-networks
connections:
- Guo Wengui financial network
- Conservative media infrastructure
- Transnational influence operations
location: United States
notes: Platform represents complex intersection of conservative media, foreign funding,
