...
- leveraged-buyout
sources:
- title: PE-Owned Aspen Dental Faces Yet Another Investigation for Deceptive Practices
  url: https://pestakeholder.org/news/pe-owned-aspen-dental-faces-yet-another-investigation-for-deceptive-practices-2/
  outlet: Private Equity Stakeholder Project
  date: '2024'
  tier: 3
- title: When Private Equity Firms Acquire Dental Practices, Patients Pay the Price
  url: https://truthout.org/articles/when-private-equity-firms-acquire-dental-practices-patients-pay-the-price/
  outlet: Truthout
  date: '2023'
  tier: 3
- title: Why Private Equity Firms Like Dentists, Veterinarians, and Ophthalmologists
  url: https://www.groupdentistrynow.com/dso-group-blog/why-private-equity-firms-like-dentists-veterinarians-and-opthamologists/
  outlet: Group Dentistry Now
  date: '2024'
  tier: 3
capture_lanes:
