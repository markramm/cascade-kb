...
description: Trump administration explores consolidating banking regulators by potentially
  merging FDIC and OCC under Treasury Department, reducing regulatory oversight and
  workforce. Potential scenarios include folding FDIC into Treasury, combining FDIC's
  regulatory role with OCC, or having single leadership over both agencies.
status: confirmed
importance: 8
...
notes: Part of broader effort to reduce banking regulatory complexity and oversight
capture_lanes:
- Regulatory Capture
- Legislative Capture
- Financial Capture
