...
1. **"Bias"** - Coverage deemed insufficiently favorable to the administration
2. **"False Claim"** - Factual reporting the White House disputes
3. **"Lie"** - Journalism the administration characterizes as deliberately deceptive
4. **"Left-Wing Lunacy"** - Ideological attack on progressive or critical reporting
5. **"Misrepresentation"** - Coverage that quotes Trump or officials accurately but in unflattering context
...
- **The Independent** - Two reporters specifically named:
  ...
  - Eric Garcia (Washington Bureau Chief)
...
First Amendment attorneys are exploring several potential legal theories:
1. **Prior Restraint**: Portal creates chilling effect that deters future reporting
2. **Viewpoint Discrimination**: Targets journalists based on content critical of government
3. **Retaliation for Protected Speech**: Uses government power to punish constitutionally protected journalism
