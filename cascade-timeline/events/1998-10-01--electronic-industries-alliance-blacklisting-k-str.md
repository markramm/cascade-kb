...
sources:
- title: The K Street Project and Jack Abramoff
...
- Legislative leverage as political coercion tool
patterns:
- institutional-capture
- partisan-lobbying-control
- political-infrastructure-manipulation
project_strategy_summary:
  primary_objectives:
  - Control lobbying firm hiring practices
  - Ensure Republican dominance in K Street organizations
  - Create consequences for non-compliance
  enforcement_mechanisms:
  - Blocking legislative priorities
  - Controlling access to political leadership
