...
- education-policy
sources:
- title: Violence Erupts in Boston Over Desegregation Busing
  outlet: History.com
  url: https://www.history.com/this-day-in-history/september-12/violence-in-boston-over-racial-busing
  tier: 2
  verified: true
- title: Boston Desegregation Busing Crisis
  outlet: Wikipedia
  url: https://en.wikipedia.org/wiki/Boston_desegregation_busing_crisis
  tier: 3
  verified: true
- title: Rethinking Busing in Boston
  outlet: Smithsonian National Museum of American History
  url: https://americanhistory.si.edu/explore/stories/rethinking-busing-boston
  tier: 1
  verified: true
status: confirmed
capture_lanes:
