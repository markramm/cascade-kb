...
status: confirmed
sources:
- title: Trump indicted in New York over hush money to porn star Stormy Daniels
  url: https://www.npr.org/2023/03/30/1164766452/trump-indictment-new-york-bragg-stormy-daniels
  outlet: NPR
  date: '2023-03-30'
  tier: 1
- title: Read the 34 felony charges in the Donald Trump indictment over the Stormy Daniels payoff
  url: https://www.politifact.com/article/2023/apr/04/read-34-felony-charges-donald-trump-indictment/
  outlet: PolitiFact
  date: '2023-04-04'
  tier: 2
- title: 'Trump indictment updates: Trump denies committing crimes, attacks foes in scattered Mar-a-Lago speech'
  url: https://www.cnbc.com/2023/04/04/trump-arraignment-new-york-indictment-live-updates-and-news.html
  outlet: CNBC
  date: '2023-04-04'
  tier: 2
- title: Trump indicted by Manhattan grand jury over 2016 Stormy Daniels payment
  url: https://www.axios.com/2023/03/30/trump-indicted-manhattan-grand-jury-criminal
  outlet: Axios
  date: '2023-03-30'
  tier: 2
notes: This marked the first criminal indictment of a former or current U.S. president in history. The indictment stemmed from a scheme to conceal damaging information from voters during the 2016 presidential campaign.
capture_lanes:
- Judicial Capture
