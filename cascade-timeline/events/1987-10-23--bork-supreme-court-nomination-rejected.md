...
sources:
- url: https://en.wikipedia.org/wiki/Robert_Bork_Supreme_Court_nomination
  title: Robert Bork Supreme Court nomination - Wikipedia
  date: 2025-12-22
  tier: 2
  outlet: Wikipedia
- url: https://constitutioncenter.org/blog/on-this-day-senate-rejects-robert-bork-for-the-supreme-court
  title: On This Day - Senate rejects Robert Bork for the Supreme Court
  date: 2023-10-23
  tier: 2
  outlet: National Constitution Center
- url: https://www.history.com/articles/robert-bork-ronald-reagan-supreme-court-nominations
  title: How Robert Bork's Failed Nomination Led to a Changed Supreme Court
  date: 2019-09-17
  tier: 2
  outlet: History.com
- url: https://www.npr.org/sections/itsallpolitics/2012/12/19/167645600/robert-borks-supreme-court-nomination-changed-everything-maybe-forever
  title: Robert Bork's Supreme Court Nomination 'Changed Everything, Maybe Forever'
  date: 2012-12-19
  tier: 1
  outlet: NPR
capture_lanes:
...
Bork's extensive written record — including "The Antitrust Paradox," five years of DC Circuit opinions, and academic writings criticizing privacy rights, civil rights protections, and the "one person, one vote" principle — provided opponents with abundant material. The final 42-58 vote saw six Republicans join 52 Democrats in opposition. Reagan subsequently nominated Anthony Kennedy, a more moderate conservative without Bork's paper trail, who was confirmed 97-0 in February 1988. The term "borking" entered the political lexicon to describe aggressive scrutiny of nominees based on their ideological records.

Bork's rejection proved a pivotal lesson for the conservative legal movement rather than a permanent defeat. The Federalist Society, founded just five years earlier, dramatically expanded its activities to develop more sophisticated judicial selection criteria — identifying nominees with strong conservative credentials but limited public records of controversial positions. Leonard Leo and other conservatives studied the confirmation battle carefully, refining strategies that emphasized nominee preparation, coordinated support campaigns, and Senate caucus discipline. These lessons were applied in every subsequent Republican Supreme Court confirmation, culminating in the 6-3 conservative majority achieved by 2020.
