...
sources:
- url: 'https://www.aclu.org/press-releases/aclu-files-amended-complaint-tincher-v-noem-ice-retaliation'
  title: 'ACLU Files Amended Complaint in Tincher v. Noem Documenting ICE First Amendment Violations'
  date: '2026-02-13'
  outlet: ACLU
  tier: 1
- url: 'https://minnesotareformer.com/2026/02/19/tincher-v-noem-press-freedom-lawsuit-grows/'
  title: 'Press Freedom Lawsuit Against ICE Grows with Journalism Union, New Plaintiffs'
  date: '2026-02-19'
...
The inclusion of the NewsGuild-CWA as a plaintiff transformed Tincher v. Noem from a civil liberties challenge into a landmark press freedom case. The journalism union's participation signaled that the documented retaliation was not merely incidental to enforcement operations but represented a direct threat to the ability of the press to cover government activity. If ICE agents could assault, threaten, and intimidate journalists and observers with impunity during enforcement operations, the practical effect would be to create zones of government action invisible to public scrutiny—precisely the conditions under which abuses of power flourish unchecked.
