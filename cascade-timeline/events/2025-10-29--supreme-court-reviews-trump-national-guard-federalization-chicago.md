...
1. **Separation of Powers**: Can the president use military forces for domestic law enforcement when civilian agencies are available?
2. **Federalism**: Can the president override governors and commandeer state military forces against state wishes?
3. **Posse Comitatus**: Does using the National Guard for immigration enforcement violate the principle against military involvement in civilian law enforcement?
4. **Statutory Authority**: What does "cannot with the regular forces execute the laws" actually mean?
