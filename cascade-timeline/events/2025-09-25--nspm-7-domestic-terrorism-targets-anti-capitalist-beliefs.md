...
**Disambiguation (June 2026):** NSPM-7 is **public and unclassified** — full text on whitehouse.gov — and is the *domestic-terrorism / ideological-targeting* directive described above. It should not be conflated with the separate **militarization-of-immigration-enforcement** authorities (the January 2025 border-deployment EO, NSPM-4 / National Defense Areas, and WEXMAC-TITUS Navy detention procurement). A prior timeline entry mis-attributed that military-immigration thread to NSPM-7; it has been corrected and de-anchored — see [[nspm-7-signed-authorizing-military-support-for-mass-immigration-enforcement-operations]]. This is the canonical NSPM-7 record.
