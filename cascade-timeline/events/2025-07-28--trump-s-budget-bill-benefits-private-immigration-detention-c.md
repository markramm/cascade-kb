---
type: timeline_event
id: 2025-07-28--trump-s-budget-bill-benefits-private-immigration-detention-c
date: '2025-07-28'
title: Trump’s budget bill benefits private immigration detention companies that donated to Trump
description: Trump’s Big Beautiful Bill allocated $45 billion for ICE detention facilities, portions of which have been awarded to CoreCivic and GEO Group–that both donated to Trump’s campaign
status: confirmed
importance: 9
...
_merge_note: 'Enhanced with information from duplicate event: 2025-07-28--trumps-budget-bill-benefits-private-immigration-de'
_merge_timestamp: '2025-09-05T23:46:55.901706'
capture_lanes:
...
CREW's investigation connected the funding directly to the donation pattern: CoreCivic and GEO Group had given to Trump-aligned causes, and the legislation they had lobbied for had provided them with an extraordinary financial windfall. The episode illustrated how immigration enforcement policy — framed as a national security and rule-of-law issue — simultaneously operated as a mechanism for transferring government revenue to politically connected private companies. The structural dynamic — private companies profiting from mass incarceration while lobbying for the policies that created that incarceration — created incentives for the expansion of detention that went beyond law enforcement rationales into pure commercial interest.
