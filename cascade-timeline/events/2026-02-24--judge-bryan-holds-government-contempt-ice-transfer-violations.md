---
type: timeline_event
id: 2026-02-24--judge-bryan-holds-government-contempt-ice-transfer-violations
date: '2026-02-24'
title: 'Judge Bryan Holds Federal Government in Contempt for ICE Transfer Violations'
importance: 9
status: confirmed
actors:
- Jeffrey Bryan
...
sources:
- url: 'https://www.mprnews.org/story/2026/02/24/judge-bryan-contempt-ice-transfer-violations'
  title: 'Federal Judge Holds Government in Contempt Over ICE Transfer Violations'
  date: '2026-02-24'
  outlet: MPR News
  tier: 1
...
The contempt finding represented a significant escalation in the judicial confrontation with ICE enforcement operations in Minnesota. Federal judges rarely hold the government in contempt, and the order reflected deep frustration with what the court characterized as a systematic pattern of disregard for judicial authority. The requirement that the U.S. Attorney personally appear at the hearing underscored the seriousness with which the court viewed the government's conduct and foreshadowed even more dramatic judicial interventions to come.
