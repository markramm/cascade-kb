...
- title: Nebraska approves path for controversial Keystone XL pipeline
  outlet: CNN
  url: https://www.cnn.com/2017/11/20/us/nebraska-keystone-xl-expansion
  date: '2017-11-20'
  verified: true
  tier: 1
- title: Nebraska regulators OK Keystone XL pipeline, but on different route
  outlet: Lincoln Journal Star
  url: https://journalstar.com/news/state-and-regional/nebraska/nebraska-ok-s-keystone-xl-pipeline-but-not-its-preferred/article_22dfecd0-1cca-52a1-a076-fd859f875a9b.html
  date: '2017-11-20'
  verified: true
  tier: 2
- title: Nebraska Landowners Pledge to Fight Eminent Domain Claims for TransCanada's Keystone XL Pipeline
  ...
  verified: true
  tier: 2
- title: TransCanada Keystone XL Pipeline Opposition Work
  outlet: Domina Law Group
  url: https://www.dominalaw.com/transcanada-keystone-xl-pipeline/
  verified: true
  tier: 2
- url: https://www.nextgov.com/modernization/2017/11/amazon-web-services-announces-secret-cloud-region-cia/142662/
  title: Amazon Web Services Announces Secret Cloud Region For CIA
  date: 2017-11-20
  tier: 1
  outlet: Nextgov/FCW
  verified: true
- url: https://techcrunch.com/2017/11/20/aws-launches-a-secret-region-for-the-u-s-intelligence-community/
  title: AWS launches a Secret region for the U.S. intelligence community
  date: 2017-11-20
  tier: 2
  outlet: TechCrunch
  verified: true
- url: https://www.theregister.com/2017/11/21/aws_secret_region/
  title: Amazon launches Secret Region – so secret it's endorsed by the CIA
  date: 2017-11-21
  tier: 2
  outlet: The Register
  verified: true
