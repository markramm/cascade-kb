...
- privatization
sources:
- title: The block that Prop. 13 built - Taxpayers revolt
  url: 'https://projects.scpr.org/prop-13/history/'
  outlet: Southern California Public Radio
  tier: 2
  verified: true
- title: 'California Proposition 13, Tax Limitations Initiative (June 1978)'
  url: 'https://ballotpedia.org/California_Proposition_13,_Tax_Limitations_Initiative_(June_1978)'
  outlet: Ballotpedia
  tier: 2
  verified: true
- title: Proposition 13
  url: 'https://www.hjta.org/propositions/proposition-13/'
...
Proposition 13 became what the Howard Jarvis Taxpayers Association described as "a California tax cut with a national identity," with the organization stating: "The tax cut message rolled across the country after Proposition 13 passed. Some say it was the spark that ignited a conflagration, which culminated in the election of Ronald Reagan to the presidency." The measure inspired numerous copycat initiatives in other states and spawned a nationwide tax-cutting fervor that defined U.S. tax politics for decades. However, the initiative's long-term effects included chronic underfunding of California's once-premier public education system, deteriorating infrastructure, increased reliance on fees and regressive taxes, and wealth transfer from younger to older property owners due to the assessment cap benefiting long-term homeowners. Proposition 13 demonstrated how anti-tax populism could be weaponized to starve public services, creating a self-fulfilling prophecy where degraded government performance justified further cuts, fundamentally reshaping the social contract between citizens and the state.
