...
- systemic-risk
sources:
- title: Warren Remarks at Vanderbilt Policy Accelerator Event Highlighting Economic and Financial Risks of Potential AI Crash
  ...
  date: '2026-04-22'
  tier: 1
- title: "After the AI Crash: A Proposal"
  url: https://cdn.vanderbilt.edu/vu-URL/wp-content/uploads/sites/412/2026/03/23144242/After-the-AI-Crash.pdf
  outlet: Vanderbilt Policy Accelerator
  date: '2026-03-23'
  tier: 1
  author: Asad Ramzanali
- title: After the AI Crash (SSRN)
  url: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6476159
  outlet: SSRN
  date: '2026'
  tier: 1
- title: "Elizabeth Warren's AI Warning"
  url: https://senatebankingdemocrats.substack.com/p/elizabeth-warrens-ai-warning
  outlet: Senate Banking Democrats Substack
  date: '2026-04-22'
  tier: 1
- title: What to Do If the AI Bubble Bursts
  url: https://www.techpolicy.press/what-to-do-if-the-ai-bubble-bursts/
...
1. **Hyperscale AI infrastructure is being financed by debt** at scale (tens of billions per project), with tenant/anchor credits that include below-investment-grade issuers.
2. **Private credit firms** (Blue Owl, Apollo, Ares, Blackstone Credit, etc.) act as the primary financiers, originating and holding loans that traditional banking regulation does not cover.
3. **Traditional banks** provide leverage to the private credit firms — bank loans to BDCs, warehouse lines, fund-level leverage — recreating the 2008 shadow-banking exposure pattern via different instruments.
4. **If AI revenue expectations collapse** — if the valuation multiples priced into the build-out do not materialize — the debt cannot be serviced, the private credit firms face redemption pressure from retail-facing vehicles (BDCs, non-traded REITs), and the banks that financed the private credit firms face concentration exposure.
5. **Pre-positioning for a bailout** is already occurring via industry lobbying for regulatory carve-outs, Fed backstops, and public-sector underwriting.
