...
- privacy-violation
sources:
- title: "DOGE is building a master database for immigration enforcement, sources say"
  url: https://www.cnn.com/2025/04/25/politics/doge-building-master-database-immigration
  outlet: CNN
  date: '2025-04-25'
  tier: 1
- title: "Palantir Partners with DOGE for Groundbreaking IRS Data Project"
  url: https://itmagazine.com/2025/04/12/palantir-partners-with-doge-for-groundbreaking-irs-data-project/
  outlet: IT Magazine
  date: '2025-04-12'
  tier: 2
- title: "Democrats press Palantir about reported creation of IRS mega-database"
  url: https://www.nextgov.com/modernization/2025/06/democrats-press-palantir-about-reported-creation-irs-mega-database/406144/
  outlet: Nextgov/FCW
  date: '2025-06-01'
  tier: 2
capture_lanes:
...
- **IRS tax records** (income, employment, addresses, SSNs)
- **Social Security files** (identity verification, benefits)
- **ICE immigration databases** (enforcement records, status)
- **DHS/CBP border crossing data**
- **USCIS application records** (via new VOWS contract)
