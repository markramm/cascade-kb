...
- jp-morgan
sources:
- title: Pujo Committee - Wikipedia
  url: 'https://en.wikipedia.org/wiki/Pujo_Committee'
  tier: 2
  outlet: Wikipedia
- title: The Man Who Killed JP Morgan
  outlet: The Mercenary Pen
  url: 'https://mercenarypen.substack.com/p/the-man-who-killed-jp-morgan'
  tier: 3
- title: 'JPMorgan scandal - What we can learn from John Pierpont Morgan''s fight with Congress 100 years ago'
  outlet: Slate
  url: 'https://slate.com/human-interest/2012/05/jpmorgan-scandal-what-we-can-learn-about-it-from-john-pierpont-morgans-fight-with-congress-100-years-ago.html'
  tier: 2
- title: The Pujo Committee
...
Morgan's death and the Pujo Committee's findings directly influenced passage of the Federal Reserve Act (1913), Federal Trade Commission Act (1914), and Clayton Antitrust Act (1914). Louis Brandeis popularized the committee's findings in his book "Other People's Money and How the Bankers Use It." However, Morgan's death did not end the House of Morgan's power—it simply passed to his son Jack and the institutional network Morgan had built. The Federal Reserve Act itself represented a compromise between those favoring government control and those favoring private bank control, with private banks controlling twelve regional Federal Reserve Banks overseen by a board of presidential appointees. This hybrid structure ensured that Wall Street influence over monetary policy would persist institutionally even as individual bankers like Morgan passed from the scene, establishing a pattern where financial power would become embedded in seemingly public institutions rather than wielded openly by individual titans.
