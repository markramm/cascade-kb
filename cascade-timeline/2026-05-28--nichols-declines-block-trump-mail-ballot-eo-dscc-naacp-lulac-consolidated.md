---
type: timeline_event
id: 2026-05-28--nichols-declines-block-trump-mail-ballot-eo-dscc-naacp-lulac-consolidated
date: '2026-05-28'
title: Judge Carl Nichols (D.D.C.) Declines to Block Trump EO 14399 Mail-Ballot Provisions in Consolidated DSCC / NAACP / LULAC Challenge, Citing Lack of Implementation Harm
importance: 9
status: confirmed
actors:
...
- usps-citizenship-list
- save-database
- voter-suppression
- 2026-midterm-window
sources:
- title: "Federal judge refuses to block Trump executive order on elections and mail ballots — for now"
  url: https://www.votebeat.org/national/2026/05/28/trump-executive-order-mail-ballots-midterm-elections-carl-nichols/
  outlet: Votebeat
  date: '2026-05-28'
  tier: 1
- title: "A federal judge in D.C. declines to block Trump's executive order on voting by mail"
  ...
  date: '2026-05-28'
  tier: 1
- title: "Federal judge refuses to block Trump order to create federal voter list and limit mail voting"
  url: https://www.pbs.org/newshour/politics/federal-judge-refuses-to-block-trump-order-to-create-federal-voter-list-and-limit-mail-voting
  outlet: PBS NewsHour
  date: '2026-05-28'
  tier: 1
- title: "Federal court hears challenge to Trump executive order restricting mail-in ballots"
  ...
  date: '2026-05-28'
  tier: 1
- title: "Trump Mail-In Voting Executive Order Challenge (NAACP) case page"
  url: https://www.democracydocket.com/cases/trump-mail-in-voting-executive-order-challenge-naacp/
...
1. **DHS State Citizenship List**: The Secretary of Homeland Security, coordinating with the Social Security Administration, compiles and transmits to each state a list of confirmed U.S. citizens who will be 18+ at the next federal election. This list is built against the DHS **SAVE** (Systematic Alien Verification for Entitlements) database, whose accuracy DHS itself quietly revised downward from 99% (2024) to 97% (2026 disclosure).
2. **USPS Mail-in and Absentee Participation List**: USPS may transmit ballots only to individuals on a state-specific list constructed from this federal data; the EO's text contemplates USPS refusing delivery of mail ballots to voters not on the list.
