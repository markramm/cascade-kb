---
type: timeline_event
id: 2026-05-29--usps-proposed-rule-mail-ballot-voter-list-federal-register-docket-2026-10968
date: '2026-05-29'
title: USPS Issues Proposed Rule (Docket 2026-10968) Implementing Trump EO 14399 — States Must Submit Mail-Ballot Voter Lists with Unique Barcodes 30 Days Before Mailing
importance: 9
status: confirmed
actors:
- David Steiner
...
tags:
- election-system-capture
- usps-rulemaking
- federal-register
- mail-ballot-eo
- executive-order-14399
- voter-list-mechanism
- save-database
- save-database-dhs-coordination
- david-steiner-postmaster-general
- 30-day-comment-period
- 2026-midterm-window
- coordination-evidence
sources:
- title: "USPS Issues Proposed Mail Voting Rules Pursuant to Trump Executive Order"
  url: https://www.cato.org/blog/usps-issues-proposed-mail-voting-rules-pursuant-trump-executive-order
  outlet: Cato at Liberty
  date: '2026-05-29'
  tier: 2
- title: "Postal Service moving forward with Trump's attack on mail voting"
  ...
  date: '2026-05-29'
  tier: 1
- title: "USPS seeks mail-in voter lists from states after Trump order"
  url: https://www.centraloregondaily.com/news/regional/usps-proposes-mail-ballot-barcode-data-requirements/article_82fb9804-6aa7-5f0d-a3ae-e90fa387f9aa.html
  outlet: Central Oregon Daily
  date: '2026-05-29'
  tier: 2
- title: "Federal Register: Ensuring Citizenship Verification and Integrity in Federal Elections"
...
1. **State submission of voter lists**: State election officials must transmit lists of mail-ballot requesters to USPS **at least 30 days before ballots are sent**. "Supplemental submissions" are permitted until the last ballot mailing day.
2. **Voters off the list don't receive ballots**: Voters whose names are not on the USPS-held list will not receive their mail ballots. USPS expressly stated it "would not verify whether individuals should or should not be included" on the lists — meaning the verification has already happened upstream (via DHS State Citizenship Lists built against the SAVE database) before USPS even sees the data.
3. **Unique barcodes**: Each mail ballot envelope would carry a unique barcode tying it to the federal list entry, enabling per-ballot tracking and rejection.
4. **Expansion of USPS role**: USPS would move from mail-delivery vendor to "assessing ballot validity, finalizing voter lists, tracking ballots, and designing ballot envelopes" (Cato).
...
The Steiner-DOJ coordination meeting referenced in Democracy Docket is the **named-conductor evidence** linking the three threads: USPS rulemaking, DOJ voter-roll litigation, and DHS citizenship-list construction are not independent agency actions but **coordinated implementation of a single Presidential directive (EO 14399) with an inter-agency steering process**. Whether the coordination architect is named in the White House, DOJ Civil Rights Division ([[dhillon-harmeet|Harmeet Dhillon]]), or via Susie Wiles / Stephen Miller's policy shop is a near-term research gap.

## Connections

- Day-after-Nichols-ruling timing: the [[2026-05-28--nichols-declines-block-trump-mail-ballot-eo-dscc-naacp-lulac-consolidated|Nichols ruling]] removed the immediate legal obstacle; USPS proceeded.
- Parallel DOJ Civil Rights Division litigation against 30 states for voter-roll access (covered in [[election-system-capture-2026|the election-system-capture-2026 theme]]) provides the upstream voter-data flow.
- Mechanism connects to the [[ziklag-operation-checkmate-coordinated-voter-roll-challenge-apparatus|Ziklag voter-roll-challenge apparatus]] (private-sector parallel) — both produce systemic disqualification of likely-Democratic voters.
