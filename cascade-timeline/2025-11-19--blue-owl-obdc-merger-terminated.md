...
- financial-capture
sources:
- title: Blue Owl Capital Corporation and Blue Owl Capital Corporation II Announce Termination of Merger
  url: https://www.blueowlcapitalcorporation.com/investors/news-events/press-releases/detail/87/blue-owl-capital-corporation-and-blue-owl-capital
  outlet: Blue Owl Capital Corporation Press Release
  date: '2025-11-19'
  tier: 1
- title: Blue Owl calls off merger of its two private credit funds after announcement rattles stock
  url: https://www.cnbc.com/2025/11/19/blue-owl-calls-off-merger-of-its-two-private-credit-funds-after-announcement-rattles-stock-sources-say.html
  outlet: CNBC
  date: '2025-11-19'
  tier: 1
- title: Blue Owl Sells $1.4B in Loans, Halts OBDC II Redemptions, and Shifts to Capital Returns
  url: https://altswire.com/blue-owl-sells-1-4b-in-loans-halts-obdc-ii-redemptions-and-shifts-to-capital-returns/
  outlet: AltsWire
  date: '2025-11'
  tier: 2
- title: Blue Owl considers reviving merger of private credit funds, contingent on fund's share price
  url: https://www.cnbc.com/2025/11/23/blue-owl-considers-reviving-merger-of-private-credit-funds-contingent-on-funds-share-price-r.html
  outlet: CNBC
  date: '2025-11-23'
  tier: 1
- title: Blue Owl halts quarterly redemptions in a non-traded BDC
  url: https://www.privatedebtinvestor.com/blue-owl-halts-quarterly-redemptions-in-a-non-traded-bdc/
  outlet: Private Debt Investor
  date: '2025-11'
  tier: 1
- title: The Blue Owl OBDC II Saga
  url: https://www.pennantpark.com/the-blue-owl-obdc-ii-saga/
  outlet: PennantPark
  date: '2025-11'
  tier: 3
status: confirmed
...
1. **Permanently halt OBDC II quarterly redemptions** — the option Jonathan Lamm had warned about in the November 16 Financial Times interview
2. **Sell approximately $1.4 billion in loans** from OBDC II to fund return-of-capital distributions
3. **Shift OBDC II's distribution model** from redemption (investor-initiated) to return of capital (board-initiated)
...
- **Backward-looking**: it terminates the private-investor-haircut mechanism that Blue Owl had tried to use to resolve the BDC redemption crisis
- **Forward-looking**: it precipitates the permanent OBDC II redemption halt, which in turn becomes one of the primary examples of non-traded BDC structural risk cited in Morningstar, Covenant Lite, and Financial Times coverage
