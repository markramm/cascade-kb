...
- democratic-erosion
sources:
- title: Puerto Rico Oversight, Management, and Economic Stability Act
  url: https://en.wikipedia.org/wiki/PROMESA
  outlet: Wikipedia
  tier: 2
- title: Frequently Asked Questions - Financial Oversight and Management Board for Puerto Rico
  url: https://oversightboard.pr.gov/faq/
  outlet: FOMB
  tier: 1
- title: 'Puerto Rico''s Fiscal Control Board: A Parallel Government Full of Lawyers and Consultants'
  url: https://www.latinousa.org/2018/08/02/puertoricofcb/
  outlet: Latino USA
  tier: 2
- title: The Unelected Board Governing Puerto Rico Will Continue to Operate in Secret
  url: https://jacobin.com/2023/05/puerto-rico-fomb-debt-board-supreme-court-ruling-transparency
  outlet: Jacobin
  tier: 2
- title: 'PROMESA: A Failed Colonial Experiment?'
  url: https://grupocne.org/2021/06/29/promesa-a-failed-colonial-experiment/
  outlet: Grupo CNE
  tier: 2
status: confirmed
capture_lanes:
