---
type: timeline_event
id: 1978-10-24--airline-deregulation-act-carter-neoliberalism
date: 1978-10-24
title: Carter Signs Airline Deregulation Act, Neoliberal Turn Begins
importance: 8
actors:
- Jimmy Carter
- Alfred Kahn
...
sources:
- title: Who Gave Away the Skies to the Airlines?
  url: https://www.thenation.com/article/society/airline-deregulation-carter-neoliberalism/
  outlet: The Nation
  tier: 2
  verified: true
- title: Airline Deregulation - When Everything Changed
  url: https://airandspace.si.edu/stories/editorial/airline-deregulation-when-everything-changed
  outlet: Smithsonian National Air and Space Museum
  tier: 1
  verified: true
- title: Neoliberal Policies Associated With Reaganomics Actually Started With Carter
  url: https://truthout.org/articles/neoliberal-policies-associated-with-reaganomics-actually-started-with-carter/
  outlet: Truthout
  tier: 2
  verified: true
- title: Airline Deregulation Act - Wikipedia
  url: https://en.wikipedia.org/wiki/Airline_Deregulation_Act
  outlet: Wikipedia
  date: '2024-01-01'
  verified: true
  tier: 2
